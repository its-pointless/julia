...
gcc-8 -fasynchronous-unwind-tables -DJL_DISABLE_LIBUNWIND -DSYSTEM_LLVM -DJULIA_HAS_IFUNC_SUPPORT=1 -DJULIA_ENABLE_THREADING -DJULIA_NUM_THREADS=3 -std=gnu99 -pipe -fPIC -fno-strict-aliasing -D_FILE_OFFSET_BITS=64 -fsigned-char -DJL_DISABLE_LIBUNWIND -Wold-style-definition -Wstrict-prototypes -Wc++-compat -O3 -ggdb2 -falign-functions -D_GNU_SOURCE -I. -I$PWD/src -I$PWD/src/flisp -I$PWD/src/support -I$PWD/usr/include -I$PWD/usr/include -DLIBRARY_EXPORTS -I$PWD/deps/valgrind -Wall -Wno-strict-aliasing -fno-omit-frame-pointer -fvisibility=hidden -fno-common -Wpointer-arith -Wundef -DJL_BUILD_ARCH='"arm"' -DJL_BUILD_UNAME='"Linux"' -I/data/data/com.termux/files/usr/include -DLLVM_SHLIB "-DJL_SYSTEM_IMAGE_PATH=\"../lib/julia/sys.so\"" -DNDEBUG -DJL_NDEBUG -c src/interpreter.c -o src/interpreter.o
